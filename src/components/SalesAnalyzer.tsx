...
const conversionFunnel = [
  ...
  { stage: 'Views', count: 8450, fill: '#fdba74' },
  { stage: 'Favorites', count: 425, fill: '#fb923c' },
  { stage: 'Add to Cart', count: 142, fill: '#f97316' },
  { stage: 'Purchases', count: 48, fill: '#ea580c' },
];
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <div className="bg-green-50 border border-green-200 rounded-lg p-3 text-sm text-green-800">
            <strong>✅ Strength:</strong> Your view-to-favorite rate (5.0%) is strong — buyers LOVE your product photos and designs.
          </div>
          <div className="bg-amber-50 border border-amber-200 rounded-lg p-3 text-sm text-amber-800">
            <strong>⚠️ Issue:</strong> Cart-to-purchase rate (34%) needs improvement, and AOV is flat at $35.74 — you're leaving money on the table with no size upsells.
          </div>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-green-500 to-emerald-600 rounded-xl p-5 text-white">
        ...
        <p className="text-sm text-green-100 mt-4 font-medium">Total estimated monthly increase: <span className="text-white text-lg font-bold">+$900</span> (52% revenue growth)</p>
      </div>
    </div>
  );
}
